...
##Graph 2
with(filteredDate_v2, plot(DateTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
##Graph 3
...
##Graph 4
with(filteredDate_v2, plot(DateTime, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()